			...
			<ul class="list-group" id="all_results">
				<li class="list-group-item clearfix">
					<div class="col-lg-2 col-md-2 col-sm-3 col-xs-4" style="background-color: white; padding-left: 0px;">
						<a href="#"><img src="//s3-media1.fl.yelpassets.com/bphoto/4FAeNpaaC4Pu1XMaIAIsjA/90s.jpg" style="width: 100%;" />
						</a>
					</div>
					...
					<div class="col-lg-3 col-md-5 col-sm-4 col-xs-12 pull-right">
						<button type="button" class="btn label-success" style="width: 100%; margin-bottom: 14px; font-weight: bold;" data-toggle="modal" data-target="#shopHoursModal"><span data-toggle="tooltip" data-placement="top" title="" data-original-title="Nu open">Open tot 15:00</span>
						</button>
					</div>
				...
				<li class="list-group-item clearfix">
					...
					<div class="col-lg-3 col-md-5 col-sm-4 col-xs-12 pull-right">
						<button type="button" class="btn label-warning" style="width: 100%; margin-bottom: 14px; font-weight: bold;" data-toggle="modal" data-target="#shopHoursModal"><span data-toggle="tooltip" data-placement="top" title="" data-original-title="Nu open">Open tot 15:00</span>
						</button>
					</div>
				</li>
				...
				<li class="list-group-item clearfix">
					...
					<div class="col-lg-3 col-md-5 col-sm-4 col-xs-12 pull-right">
						<button type="button" class="btn label-danger" style="width: 100%; margin-bottom: 14px; font-weight: bold;" data-toggle="modal" data-target="#shopHoursModal"><span data-toggle="tooltip" data-placement="top" title="" data-original-title="Nu open">Gesloten</span>
						</button>
					</div>
				</li>
